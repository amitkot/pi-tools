...
- `@amitkot/pi-deliver-code-changes` package with `/deliver` and the `deliver-code-changes` skill.
- `@amitkot/pi-precommit-setup` package with `/add-precommit` for Rust and Python pre-commit profiles.
